...
<body>
		<div class="col-lg-12" style="background-color: #9EC1E8; border-radius: 5px; min-height: 800px; border: 1px solid #437EC0; margin-bottom:100px;">
									...
									<div class="answer_box" style="height:150px; padding: 20px; border-top: 1px solid #9D9D9D;">		<!-- 개별 질문 박스 -->
										<div class="answer_box_header">																<!-- 질문박스 위의 제목 + 내용 -->
											<c:if test="${fn:length(vo.subject)>35 }">
												<a href="../jobKnowledge/detail_before.do?no=${vo.no }" style="text-decoration: none; color:black;">
