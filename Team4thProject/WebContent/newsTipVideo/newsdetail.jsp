        ...
        <tr>
          ...
          <td class="text-right">
            <c:if test="${sessionScope.id==rvo.id }">
             <span class="btn btn-xs btn-primary news_reply_update" value="${rvo.no }">수정</span>
             <a href="../newsTipVideo/news_reply_delete.do?no=${rvo.no }&bno=${vo.n_no}" class="btn btn-xs btn-success">삭제</a>
            </c:if>
             <span class="btn btn-xs btn-danger news_reply_reply" value="${rvo.no }">댓글</span>
          </td>
        </tr>
        <tr>
