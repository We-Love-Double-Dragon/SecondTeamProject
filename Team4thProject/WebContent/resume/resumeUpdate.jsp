					...
					<table class="rform">
 				  	...
 				  	<input type=hidden name=no value="${vo.no }">
					  	...
					  	<tr>
					  	  ...
					  	  <td width=80%>
					  	    <input type=text name=subject  placeholder=" 제목을 입력하세요" id="subject"  style="width: 435px" value="${vo.subject }">
					  	  	<textarea rows="8" cols="55" name="cl" id="cl" placeholder=" 내용을 입력하세요.">${vo.cl }</textarea>
					  	  </td>
					  	</tr>
					</table>
